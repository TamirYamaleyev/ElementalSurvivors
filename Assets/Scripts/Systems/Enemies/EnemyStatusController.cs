...
public class EnemyStatusController : MonoBehaviour
{
    ...
    {
        if (type == StatusType.None || owner == null || !owner.gameObject.activeInHierarchy || !IsOwnerAlive())
            return;
    ...
    /// <summary>Full gameplay + VFX reset when an enemy leaves or re-enters the pool.</summary>
    public void ResetForPool()
    {
        ClearAllStatuses();
        VisualSink?.ResetForPool();
    }
