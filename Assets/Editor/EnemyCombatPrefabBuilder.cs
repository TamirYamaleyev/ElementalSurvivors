...
public static class EnemyCombatPrefabBuilder
{
    ...
    private const string ArcherSpriteSheetPath = "Assets/Sprites/IMG_0616.png";
    private const string ArcherSpriteName = "IMG_0616_2";
    ...
    private static Enemy BuildRangedEnemy(EnemyProjectile projectile)
    {
        ...
        if (visual != null)
        {
            visual.localScale = new Vector3(0.8f, 0.8f, 1f);

            var archerSprite = LoadSpriteFromSheet(ArcherSpriteSheetPath, ArcherSpriteName);
